...
class Manager extends Member {
    ...
    public String toString() {
        return "Manager { " + "Manager Specialization : " + specialization + ", Manager Department : " + department
                + ", Manager Name:  " + Name + " , Manager Address : " + Address + ", Manager Age : " + Age
                + ", Manager Phone Number: " + PhoneNumber + " , Manager Salary : " + Salary + "}";
    }
}
...
class Employee extends Member {
    ...
    @Override
    public String toString() {
        return "Employee { " + "Employee Specialization : " + specialization + ", Employee Department : " + department
                + ", Employee Name : " + Name + ", Employee Address : " + Address + ", Employee Age : " + Age
                + ", Employee Phone Number:  " + PhoneNumber + ", Employee Salary : " + Salary + " } ";
    }
}